...
Let a point $p=1$ in the codomain of $f$ be mapped to by some point in $(0,1)$ the domain of $f$. So $p=f^{-1}(1)\in(0,1)$  If we restrict $f$ by removing the point $p$, then $f$ becomes $f|_{(0,1)\setminus\{p\}}:(0,1)\setminus \{p\}\rightarrow (0,1]\setminus \{p\}$. $(0,1)\setminus \{p\}=(0,p)\cup (p,1)$ and must be disconnected, however $$
